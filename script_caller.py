...
def one_2d(lens_filename, z_init, y_init, slope_init, *z_screen):
    if z_screen is not None:
        os.system( "python raytracing/one_2d.py {} {} {} {}".format(lens_filename, z_init, y_init, z_screen) )
    else:
        os.system( "python raytracing/one_2d.py {} {} {}".format(lens_filename, z_init, y_init) )
...
def par_2d(lens_filename, z_init, y_init, slope_init, offset, *z_screen):
    if z_screen is not None:
        os.system( "python raytracing/one_2d.py {} {} {} {} {} {}".format(lens_filename, z_init, y_init, slope_init, offset, z_screen) )
    else:
        os.system( "python raytracing/one_2d.py {} {} {} {} {}".format(lens_filename, z_init, y_init, slope_init, offset) )
...
# 	[z_screen]	optional screen location for analysis of ray positions
def point_2d(lens_filename, z_init, y_init, slope_init, offset_angle, *z_screen):
    if z_screen is not None:
        os.system( "python raytracing/one_2d.py {} {} {} {} {} {}".format(lens_filename, z_init, y_init, slope_init, offset_angle, z_screen) )
    else:
        os.system( "python raytracing/one_2d.py {} {} {} {} {}".format(lens_filename, z_init, y_init, slope_init, offset_angle) )